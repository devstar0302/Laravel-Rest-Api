...
@section('content')
    ...
    <div class="panel-body" style="width:90%;margin-left:5%">
                ...
                <form role="form" action="{{ url('/admin/thirdparty/'.$payment->id.'/update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group has-success">
                        <label class="control-label" style="font-size: 120%" for="name">{{ _t('Third Party Secret', [], $_SESSION['lang']) }}</label>
                        <div>
                            <input type="text" class="form-control" name="secret" value="{{ $payment->secret }}">
                        </div>
                    </div>
                    <div class="form-group has-success">
                        <label class="control-label" style="font-size: 120%" for="name">{{ _t('Third Party API Key', [], $_SESSION['lang']) }}</label>
                        <div>
                            <input type="text" class="form-control" name="api_key" value="{{ $payment->api_key }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mar-10" style="padding-top:30px;">
                        ...
                        <div class="col-lg-6">
                            <input type="submit" value="{{ _t('Update', [], $_SESSION['lang']) }}" style="font-size: 120%" class="btn btn-success btn-block btn-md btn-responsive">
                        </div>
                    </div>
                </form>
    </div>
