...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ _t('News', [], $_SESSION['lang']) }}</li>
        </ol>
    </section>
    <!-- Main content -->
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Description
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Description', [], $_SESSION['lang']) }}
                                </th>
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Photo
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('News Image', [], $_SESSION['lang']) }}
                                </th>
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Favorites
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Likes', [], $_SESSION['lang']) }}
                                </th>
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Favorites
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Dislikes', [], $_SESSION['lang']) }}
                                </th>
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Comments
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Comments', [], $_SESSION['lang']) }}
                                </th>
...
@section('footer_scripts')
        ...
        $(function () {
            ...
            table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'likenum', name: 'likenum'},
                    {data: 'dislikenum', name: 'dislikenum'},
                    {data: 'comment_num', name: 'comment_num', searchable: false},
    ...
    <script>
        ...
        function inactive_data(){
            ...
            $.ajax({
                type: "get",
                url: '/admin/news/' + id + '/inactivedata',
                success: function (result) {
