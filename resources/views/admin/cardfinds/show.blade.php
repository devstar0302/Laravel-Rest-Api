                ...
                <!--<form role="form" action="{{ route('admin.cardfinds.adddata') }}" method="POST" enctype="multipart/form-data">-->
                    ...
                    <div class="form-group has-success row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                <input type="text" class="form-control" id="email" name="email" disabled readonly value="{{$email_str}}" placeholder="email">
                            </div>
                        </div>
                    </div>
                    <div class="form-group has-success row">
                    ...
                    <div class="form-group has-success " style="padding: 0px 15px;">
                        ...
                        <div>
                            <div class="form-group">
                                <img src="{{ url('/').'/uploads/card_picture/'.$picture_list[0] }}" style="max-width: 200px; min-height: 100px;">
                            </div>
                        </div>
                        <?php
                            }
                            ...
                            {{--<div class="row" style="margin-bottom: 10px">--}}
                                ...
                                {{--<div class="col-sm-10">--}}
                                    {{--<input value="Jobs" type="checkbox" class="form-control"--}}
                                           {{--{{ in_array('Jobs', $section_list)? 'checked':''}} disabled readonly style="width:16px;height:16px;margin-top:0px;"/>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            ...
                            <div class="row" style="margin-bottom: 10px">
                                ...
                                <div class="col-sm-10">
                                    <input id="section_{{ $num }}" value="{{ $section->name }}" type="checkbox" class="form-control"
                                           {{ in_array($section->name, $section_list)? 'checked':''}} disabled readonly
