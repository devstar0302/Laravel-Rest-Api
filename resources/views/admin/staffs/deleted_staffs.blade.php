...
{{-- Page title --}}
@section('title')
    {{ _t(config('Convert.delete_admins')[0], [], $_SESSION['lang']) }}
@parent
@stop
...
<section class="content-header">
                <h1>{{ _t(config('Convert.delete_admins')[0], [], $_SESSION['lang']) }}</h1>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li class="active">{{ _t(config('Convert.delete_admins')[0], [], $_SESSION['lang']) }}</li>
                </ol>
            </section>
            <!-- Main content -->
                ...
                <table class="table table-bordered" id="table">
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('restore/staff', $user->id) }}"><i class="livicon" data-name="user-flag" data-c="#6CC66C" data-hc="#6CC66C" data-size="18"></i></a>
                            </td>
                        </tr>
                    @endforeach
