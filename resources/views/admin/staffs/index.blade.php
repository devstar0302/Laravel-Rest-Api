...
{{-- Page title --}}
@section('title')
    {{ _t(config('Convert.admins')[0], [], $_SESSION['lang']) }}
@parent
@stop
...
<section class="content-header">
    <h1>{{ _t(config('Convert.admins')[0], [], $_SESSION['lang']) }}</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">{{ _t(config('Convert.admins')[0], [], $_SESSION['lang']) }}</li>
    </ol>
</section>
                ...
                <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                            colspan="1"  aria-label="
                                                   User Photo
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('User Photo', [], $_SESSION['lang']) }}
                        </th>
                        <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                            colspan="1"  aria-label="
                                                   First Name
                        ...
                        <th class="sorting" tabindex="0" aria-controls="paidtable" rowspan="1"
                            colspan="1" aria-label="
                                                User Gender
                                            : activate to sort column ascending" style="width: 100px;">{{ _t(config('Convert.gender')[0], [], $_SESSION['lang']) }}
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="paidtable" rowspan="1"
                            colspan="1" aria-label="
                                                Privilege Read
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Privilege Read', [], $_SESSION['lang']) }}
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="paidtable" rowspan="1"
                            colspan="1" aria-label="
                                                Privilege Write
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Privilege Write', [], $_SESSION['lang']) }}
                        </th>
                        <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                            colspan="1"  aria-label="
                                                   Status
