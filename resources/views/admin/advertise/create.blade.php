...
{{-- Page title --}}
@section('title')
    {{ config('Convert.add_advertises')[0] }}
    @parent
@stop
...
@section('content')
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>{{ config('Convert.add_advertises')[0] }}</h1>
        <ol class="breadcrumb">
            <li>
                <a href="">
            ...
            <li class="active">{{ config('Convert.add_advertises')[0] }}</li>
        </ol>
    </section>
    ...
    <div class="panel-body" style="width:90%;margin-left:5%">
                ...
                <form role="form" action="{{ route('admin.advertise.adddata') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group has-success">
                        ...
                        <div>
                            <input type="text" class="form-control" name="title" value="" placeholder="advertise title">
                        </div>
                    </div>
                    <div class="form-group has-success">
                    ...
                    <div class="form-group has-success">
                        ...
                        <div>
                            <input type="text" class="form-control" name="weburl" value="" placeholder="advertise web url">
                        </div>
                    </div>
                    <div class="form-group has-success">
                    ...
                    <div class="col-md-12 mar-10" style="padding-top:30px;">
                        <input type="submit" value="{{ config('Convert.add_advertises')[0] }}" style="font-size: 120%" class="btn btn-success btn-block btn-md btn-responsive">
                    </div>
                </form>
    </div>
