...
{{-- Page title --}}
@section('title')
    {{ _t('Edit Advertisement', [], $_SESSION['lang']) }}
    @parent
@stop
...
@section('content')
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>{{ _t('Edit Advertisement', [], $_SESSION['lang']) }}</h1>
        <ol class="breadcrumb">
            <li>
                <a href="">
            ...
            <li class="active">{{ _t('Edit Advertisement', [], $_SESSION['lang']) }}</li>
        </ol>
    </section>
    ...
    <div class="panel-body" style="width:90%;margin-left:5%">
                ...
                <form role="form" action="{{ url('/admin/advertisement/'.$notification->id.'/update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group has-success">
                        ...
                        <div>
                            <input type="text" class="form-control" name="title" value="{{ $notification->title }}" placeholder="notification title">
                        </div>
                    </div>
                    <div class="form-group has-success">
                        ...
                        <div class="row">
                            <div class="panel panel-success">
                                <div class="bootstrap-admin-panel-content">
                                    <textarea id="ckeditor_full" name="description">{{ $notification->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-success">
                        ...
                        <div>
                            <input type="text" class="form-control pull-right" id="expired" name="expired" size="20" placeholder="expired date" value="{{ $notification->expired }}">
                        </div>
                    </div>

                    <div class="col-md-12 mar-10" style="padding-top:30px;">
                        <div class="col-lg-6">
                            <input type="button" value="Back" style="font-size: 120%" class="btn btn-danger btn-block btn-md btn-responsive" onclick="javascript:history.back();">
                        </div>
                        <div class="col-lg-6">
                            <input type="submit" value="{{ _t('Update Advertisement', [], $_SESSION['lang']) }}" style="font-size: 120%" class="btn btn-success btn-block btn-md btn-responsive">
                        </div>
                    </div>
                </form>
    </div>
