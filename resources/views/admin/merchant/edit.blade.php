...
{{-- Page title --}}
@section('title')
{{ _t('Edit Merchant', [], $_SESSION['lang']) }}
@parent
@stop
...
<section class="content-header">
    <h1>{{ _t('Edit Merchant', [], $_SESSION['lang']) }}</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">{{ _t('Edit Merchant', [], $_SESSION['lang']) }}</li>
    </ol>
</section>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"> <i class="livicon" data-name="users" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
                        {{ _t('Edit Merchant', [], $_SESSION['lang']) }} : {!! $user->first_name!!} {!! $user->last_name!!}
                    </h3>
