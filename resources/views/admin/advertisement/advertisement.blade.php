...
{{-- Page title --}}
@section('title')
    {{ _t('Advertisements', [], $_SESSION['lang']) }}
    @parent
@stop
...
@section('content')
    <section class="content-header">
        <h1>{{ _t('Advertisements', [], $_SESSION['lang']) }}</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li><a href="#"> {{ _t('Advertisements', [], $_SESSION['lang']) }}</a></li>
            <li class="active">{{ _t('Advertisements', [], $_SESSION['lang']) }}</li>
        </ol>
    </section>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   Title
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Advertisement Title', [], $_SESSION['lang']) }}
                            </th>
                            <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   Description
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Advertisement Description', [], $_SESSION['lang']) }}
                            </th>
                            <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   expired
...
@section('footer_scripts')
    ...
    <script>
        ...
        function deleteData(){
            ...
            $.ajax({
                type: "get",
                url: '/admin/advertisement/' + id + '/delete',
                success: function (result) {
                    if(result == ''){
