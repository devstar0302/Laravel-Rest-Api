                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Rating
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Rating', [], $_SESSION['lang']) }}
                                </th>
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Content
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Content', [], $_SESSION['lang']) }}
                                </th>
    ...
    <script>
        ...
        $(function () {
            ...
            table = $('#datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route("admin.section.comments.data", $news_id) !!}',
                columns: [
                    {data: 'id', name: 'id'},
