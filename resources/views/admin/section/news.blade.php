...
@section('content')
    ...
    <section class="content-header">
        <h1>{{ _t($sectionType, [], $_SESSION['lang']) }}</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active">{{ _t($sectionType, [], $_SESSION['lang']) }}</li>
        </ol>
    </section>
    <!-- Main content -->
                        ...
                        <h3 class="panel-title">
                                    <span style="font-size: 110%">
                                     <i class="livicon" data-name="notebook" data-size="15" data-c="#fff" data-hc="#fff"
                                        data-loop="true"></i>
                                        {{ _t($sectionType, [], $_SESSION['lang']) }}</span>
                        </h3>
                    </div>
