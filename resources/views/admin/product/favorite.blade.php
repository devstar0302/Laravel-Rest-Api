...
{{-- Page title --}}
@section('title')
    {{ _t('Favorited Products', [], $_SESSION['lang']) }}
    @parent
@stop
...
@section('content')
    <section class="content-header">
        <h1>{{ _t('Favorited Products', [], $_SESSION['lang']) }}</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li><a href="#"> {{ _t('Favorited Products', [], $_SESSION['lang']) }}</a></li>
            <li class="active">{{ _t('Favorited Products', [], $_SESSION['lang']) }}</li>
        </ol>
    </section>
            ...
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            {!! Form::open(['url'=>url('/admin/getfavorites'),'class'=>'productfrom', 'id'=>'productfrom']) !!}
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-striped table-bordered" id="table1">
                                ...
                                <tr>
                                    ...
                                    <th>{{ _t('Favorite User', [], $_SESSION['lang']) }}</th>
                                ...
                                foreach($favorites as $product){
                                    ...
                                    $favousername = '';
                                    $favouserphoto = '';
                                    $favouser = DB::table('users')->where('id', $product->user_id)->first();
                                    if(!empty($favouser)){
                                        $favousername = $favouser->first_name.' '.$favouser->last_name;
                                        $favouserphoto = '<img src="/img/userimage.png" style="width:40px;height:40px;border-radius:50%"/>';
                                        if(!empty($favouser->pic)){
                                            $favouserphoto = '<img src="/uploads/users/'.$favouser->pic.'" style="width:40px;height:40px;border-radius:50%"/>';
                                        }
                                    }
                                ...
                                <tr>
                                    <td>{{ $i }}</td>
                                    <td>{!! $favouserphoto !!}&nbsp;{{ $favousername }}</td>
                                    <td>{{ $categoryname }}</td>
