...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ _t('Type', [], $_SESSION['lang']) }}</li>
        </ol>
    </section>
    <!-- Main content -->
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">
                                    <span style="font-size: 110%">
                                     <i class="livicon" data-name="spinner-five" data-size="15" data-c="#fff" data-hc="#fff"
                                        data-loop="true"></i>
                                        {{ _t('Type', [], $_SESSION['lang']) }}</span>
                        </h3>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Name
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Type Name', [], $_SESSION['lang']) }}
                                </th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                <div class="modal-header" style="font-size: 150%">
                    ...
                    <h4 class="modal-title" id="myModalLabel">{{ _t('Add Type', [], $_SESSION['lang']) }} </h4>
                </div>
                <div class="modal-body" style="font-size: 120%">
                    <table style="width:50%" class="table form-body" border="0">
                        <tr style="border:0">
                            <th style="border:0">{{ _t('Type Name', [], $_SESSION['lang']) }}:</th>
                            <td style="border:0">
                                <input type="text" name="name" class="form-control" id="name"  value="" placeholder="{{ _t('type name', [], $_SESSION['lang']) }}">
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="addType()">{{ _t('Add', [], $_SESSION['lang']) }}</button>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="deleteType()">{{ _t('Delete', [], $_SESSION['lang']) }}</button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal">{{ _t('Cancel', [], $_SESSION['lang']) }}</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="activeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="inactive_type()">{{ _t('OK', [], $_SESSION['lang']) }}</button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal">{{ _t('Cancel', [], $_SESSION['lang']) }}</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="inactiveModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="active_type()">{{ _t('OK', [], $_SESSION['lang']) }}</button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal">{{ _t('Cancel', [], $_SESSION['lang']) }}</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function addType () {
            ...
            if (name == "") {
                ...
                $('#messagecontent').html('{{ _t("Please input type name.", [], $_SESSION['lang']) }}');
        ...
        function inactive_type(){
            var id = $('#occ_id').val();
            console.log(id);
            // console.log(id);
            $.ajax({
                type: "get",
                url: '/admin/types/' + id + '/inactivetype',
                success: function (result) {
