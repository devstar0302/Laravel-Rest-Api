...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ _t('Contact', [], $_SESSION['lang']) }}</li>
        </ol>
    </section>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   Contacted User
                                            : activate to sort column ascending" style="width: 100px;">{{ _t(config('Convert.contactUser')[0], [], $_SESSION['lang']) }}
                            </th>
