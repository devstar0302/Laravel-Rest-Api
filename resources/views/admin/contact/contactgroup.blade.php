...
@section('content')
    <section class="content-header">
        <h1>{{ _t('Contact', [], $_SESSION['lang']) }}</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li><a href="#"> {{ _t('Contact', [], $_SESSION['lang']) }}</a></li>
            <li class="active">{{ _t('ContactGroup', [], $_SESSION['lang']) }}</li>
        </ol>
    </section>
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading">
                    <h4 class="panel-title"> <i class="livicon" data-name="spinner-six" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                        {{ _t('Contact Group', [], $_SESSION['lang']) }}
                    </h4>
                </div>
                <br />
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   Master User
                                            : activate to sort column ascending" style="width: 100px;">{{ _t(config('Convert.masterUser')[0], [], $_SESSION['lang']) }}
                            </th>
                            <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   Contacted Group
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Contacted Group', [], $_SESSION['lang']) }}
                            </th>
                            <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   Group Members
                                            : activate to sort column ascending" style="width: 100px;">{{ _t('Group Members', [], $_SESSION['lang']) }}
                            </th>
    ...
    <script>
        ...
        $(function() {
            ...
            table = $('#notificationtable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.contact.groupdata') !!}',
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'create_userid', name: 'create_userid' },
