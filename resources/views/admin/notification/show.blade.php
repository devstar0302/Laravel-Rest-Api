...
{{-- Page title --}}
@section('title')
    {{ _t('Notification Detail', [], $_SESSION['lang']) }}
    @parent
@stop
...
@section('content')
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>{{ _t('Notification Detail', [], $_SESSION['lang']) }}</h1>
        <ol class="breadcrumb">
            <li>
                <a href="">
            ...
            <li class="active">{{ _t('Notification Detail', [], $_SESSION['lang']) }}</li>
        </ol>
    </section>
    ...
    <div class="panel-body" style="width:90%;margin-left:5%">
                ...
                <!--<form role="form" action="{{ route('admin.notification.adddata') }}" method="POST" enctype="multipart/form-data">-->
                    ...
                    <div class="col-md-12 mar-10" style="padding-top:30px;">
                        ...
                        <div class="col-lg-6">
                        <input type="submit" value="{{ _t('Edit Notification', [], $_SESSION['lang']) }}" style="font-size: 120%" class="btn btn-success btn-block btn-md btn-responsive" onclick="editNotification()">
                        </div>
                    </div>
                <!--</form>-->
    </div>
...
@section('footer_scripts')
    ...
    <script>
        ...
        function editNotification(){
            location.href="{{ url('/admin/notification/'.$notification->id.'/edit') }}";
        }
    </script>
